...
def FindNextJob(waiting_list, appDur_sorted_dd, cpuTime_sorted, active_job_list, app2newfeat_dd, 
    ...
    for (sel_appname, _) in threads_sorted: 
...
def main():
    ...
    for i in launch_list:
        ...
        threads = app2newfeat_dd[i][4] 
        threads_dd[i] = threads
        appDur_dd[i] = appDur
    ...
    threads_sorted = sorted(threads_dd.items(), key=operator.itemgetter(1))
        ...
        if Dispatch:
            ...
            if len(active_job_list) == 1:
                ...
                anotherApp = FindNextJob(waiting_list, appDur_sorted, cpuTime_sorted,
                        active_job_list, app2newfeat_dd, app2app_dist, threads_sorted)
