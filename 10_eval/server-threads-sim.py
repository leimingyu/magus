...
def FindNextJob(waiting_list, appDur_sorted_dd, cpuTime_sorted, active_job_list, app2newfeat_dd, app2app_dist):
    app1= active_job_list[0]

    app1_feats = app2newfeat_dd[app1]
    app1_threads = app1_feats[4] # avg threads
    ...
    #
    dist_dd = app2app_dist[app1] # get the distance dict
    ...
    for (sel_appname, _) in reversed(dist_sorted):
        left_threads = DEVMAXTHREAD - app2newfeat_dd[sel_appname][4] 
        if sel_appname in waiting_list and left_threads > app1_threads:
        ...
        if Dispatch:
            ...
            if len(active_job_list) == 1:
                ...
                anotherApp = FindNextJob(waiting_list, appDur_sorted, cpuTime_sorted,
                        active_job_list, app2newfeat_dd, app2app_dist)
