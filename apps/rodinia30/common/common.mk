...
SM_VERSIONS := sm_30 sm_35 sm_50 sm_52 sm_60
...
$(OBJDIR)/%.o : $(SRCDIR)%.cu $(CU_DEPS)
	$(VERBOSE)$(NVCC) $(NVCCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(CUBINDIR)/%.cubin : $(SRCDIR)%.cu cubindirectory
	$(VERBOSE)$(NVCC) $(CUBIN_ARCH_FLAG) $(NVCCFLAGS) $(GENCODE_FLAGS) -o $@ -cubin $<
