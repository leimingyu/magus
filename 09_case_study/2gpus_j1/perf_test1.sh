...
app2_keyword="fastWashTransform"
app2=$app2_keyword

app3_keyword="MC_EstimatePiInlineP"
app3=$app3_keyword

app4_keyword="MC_EstimatePiInlineQ"
app4=$app4_keyword
...
do
  ...
  # gpu 1
  cd ../../../devid_cudasdk80/6_Advanced/fastWalshTransform/ 
  timeApp $app2_keyword ./run.sh 1 &

  # gpu 0
  cd ../../../devid_cudasdk80/7_CUDALibraries/MC_EstimatePiInlineP
  timeApp $app3_keyword ./run.sh 0 &

  # gpu 1
  cd ../../../devid_cudasdk80/7_CUDALibraries/MC_EstimatePiInlineQ
