...
scriptDir="./perf2_tests"
if not os.path.exists(scriptDir):
    os.mkdir(scriptDir)


def gen_sim2(current_dir, app1, app1_dir, app2, app2_dir, scriptDir='perf2_tests'):
...
top3_leastslowdown_dd = np.load('top3_leastslowdown_perfmodel.npy').item()

app2dir_dd = np.load('../app2dir_dd.npy').item()

for app, top3_list in top3_leastslowdown_dd.iteritems():
    #print app, top3_list
