#!/bin/bash
app1="simpleCUFFT_callback"
app1_keyword="simpleCUFFT_callback"
app1_cmd="../../test_apps/simpleCUFFT_callback/simpleCUFFT_callback"

app2="conjugateGradient"
app2_keyword="conjugateGradient"
app2_cmd="../../test_apps/conjugateGradient/conjugateGradient"
