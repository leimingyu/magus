...
def main():
    ...
    apps_list = get_appinfo('./prepare/bigjob_info.bin')
    ...
    # NOTE: change the interval here
    #apps_start_list = getAppStartTime(apps_num, interval_sec=0.5, pattern="fixed")
    ...
    #gen_app_seq(app_v1, wait_time_list, outFile="run_1s_seq1.sh")
    #gen_app_seq(app_v2, wait_time_list, outFile="run_1s_seq2.sh")
    #gen_app_seq(app_v3, wait_time_list, outFile="run_1s_seq3.sh")

    #gen_app_seq(app_v1, wait_time_list, outFile="run_5s_seq1.sh")
    #gen_app_seq(app_v2, wait_time_list, outFile="run_5s_seq2.sh")
    #gen_app_seq(app_v3, wait_time_list, outFile="run_5s_seq3.sh")

    gen_app_seq(app_v1, wait_time_list, outFile="run_bigjob_1s_seq1.sh")
    #gen_app_seq(app_v2, wait_time_list, outFile="run_bigjob_1s_seq2.sh")
    #gen_app_seq(app_v3, wait_time_list, outFile="run_bigjob_1s_seq3.sh")
